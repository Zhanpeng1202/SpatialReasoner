...
def main():
    ...
    script_configs = {
        ...
        "get_obj_rel_distance_qa.py": {"subdir": "vsibench", "num_subsample": "100"},
        # "get_spatial_temporal_appearance_order_qa.py": {"subdir": "vsibench", "num_subsample": "30"},

        # # === VSDRBench Tasks (Added) ===
        # "get_camera_displacement_qa.py": {"subdir": "vsdrbench", "num_subsample": str(args.num_subsample)},
        # "get_cam_obj_abs_dist_qa.py": {"subdir": "vsdrbench", "num_subsample": str(args.num_subsample)},
        ...
        # "get_cam_obj_rel_dist_qa.py": {"subdir": "vsdrbench", "num_subsample": str(args.num_subsample)},
    ...
    for python_file in python_files_to_run:
        ...
        module_name = f"src.tasks.{subdir}.{python_file[:-3]}"

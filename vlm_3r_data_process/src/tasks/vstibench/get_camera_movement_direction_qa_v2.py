...
try:
    ...
    from ...utils.common_utils import from_options_to_mc_answer
except ImportError:
    import sys
...
class CameraMovementDirectionQAGeneratorV2(BaseQAGenerator):
    ...
    def get_default_args(self):
        ...
        return {
            'question_template_name': 'VSTI_CAMERA_MOVEMENT_DIRECTION_TEMPLATE_V2',
            'num_subsample': 5,
    ...
    def _format_qa_item(self, scene_name: str, scene_info: Dict, qa_candidate: Dict, num_frames: int) -> Optional[Dict]:
        # qa_candidate["question_template_name"] holds the name like 'VSTI_CAMERA_MOVEMENT_DIRECTION_TEMPLATE_V2'

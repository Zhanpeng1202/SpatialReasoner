...
class TStarFramework:
    ...
    def run(self, video_path: str, question: str, options: str):
        """
        ...
        all_frames, time_stamps = self.perform_search(video_searcher, visualization=False)
...
def initialize_heuristic(heuristic_type: str = "owl-vit") -> HeuristicInterface:
    ...
    if heuristic_type == 'owl-vit':
        ...
        config_path = "/home/zhanpeng/code/Reasoning/TStar/YOLO-World/configs/pretrain/yolo_world_v2_xl_vlpan_bn_2e-3_100e_4x8gpus_obj365v1_goldg_train_lvis_minival.py"
        checkpoint_path = "/data/zhanpeng/weight/Tstar/YOLO-world/yolo_world_v2_xl_obj365v1_goldg_cc3mlite_pretrain-5daf1395.pth"
...
if __name__ == "__main__":
    ...
    video_path = "/home/zhanpeng/code/Reasoning/TStar/LVHaystackBench/playground/03e90bbc-7d6b-423c-84d9-b5be3eff11c5.mp4"
